...
func New(database *mongo.Database, firebase *firebase.App, boltDB *bbolt.DB) *gin.Engine {
	...
	router.PATCH("/workouts/color/:id", workoutgen2.ColorWorkout(database))
	router.PATCH("/workouts/stretch/color/:id", workoutgen2.ColorStretchWorkout(database))
