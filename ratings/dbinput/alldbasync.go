...
func AllInputsAsync(database *mongo.Database, username string) (datatypes.User, datatypes.Workout, int64, int64, map[string]datatypes.Exercise) {
	...
	go func() {
		defer wg.Done()
		workout = GetPastWOsDB(database, username)
	}()
