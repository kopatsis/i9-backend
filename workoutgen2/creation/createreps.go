...
func GetReps(matrix datatypes.TypeMatrix, minutes, adjlevel float32, times [9]datatypes.ExerciseTimes, user datatypes.User, exerIDs [9][]string, exers map[string]datatypes.Exercise, types [9]string) [9][]int {
